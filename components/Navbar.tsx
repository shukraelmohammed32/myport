  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200/70 bg-white/75 backdrop-blur-xl dark:border-slate-800/80 dark:bg-slate-950/75">
      ...
      <Container className="relative flex h-[4.5rem] items-center justify-between">
        ...
        <nav className="hidden items-center gap-1 rounded-full border border-slate-200/80 bg-white/80 p-1 shadow-sm shadow-slate-300/35 dark:border-slate-700/80 dark:bg-slate-900/80 dark:shadow-none md:flex">
          {navigation.map((item) => (
            <Link
              key={item.href}
              href={item.href}
        ...
        <div className="flex items-center gap-2 md:hidden">
          ...
          <button
            ...
            className="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-700 transition hover:border-teal-500/40 hover:text-teal-700 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300 dark:hover:border-teal-300/40 dark:hover:text-teal-200"
      ...
      {menuOpen ? (
        <div className="border-t border-slate-200/80 bg-white/90 backdrop-blur-xl dark:border-slate-800 dark:bg-slate-950/90 md:hidden">
